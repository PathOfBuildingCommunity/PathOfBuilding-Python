...
from qdarktheme.qtpy.QtWidgets import QCheckBox, QComboBox, QPushButton, QListWidgetItem, QSpinBox, QWidget
...
class GemUI(QWidget):
    ...
    def __init__(self, my_list_item, json_gems, parent_notify, gem=None) -> None:
        ...
        self.combo_gem_variant.setGeometry(QRect(420, 1, 90, 22))
        self.check_gem_enabled = QCheckBox(self)
        self.check_gem_enabled.setGeometry(QRect(530, 3, 20, 20))
        self.check_gem_enabled.setChecked(True)
        self.spin_gem_count = QSpinBox(self)
        self.spin_gem_count.setGeometry(QRect(570, 1, 50, 24))
